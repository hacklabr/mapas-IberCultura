...
<div class="home-developers">
    <div class="home-developers__background">
        <img class="home-developers__background-img" src="<?= $this->asset("img/home--developers.jpg",false)?>" />
        <div class="home-developers__background-mask"></div>
    </div>
