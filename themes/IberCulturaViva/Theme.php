    ...
    function _init()
    {
        ...
        $app->hook('app.init:after', function () {
            ...
            if($this->config['app.lcode'] == 'pt_BR'){
                ...
                $this->config["text:home-feature.description"] = "Faça parte desta plataforma livre, colaborativa e interativa que conecta agentes culturais, iniciativas e espaços em toda a Ibero-América. Contribua para o fortalecimento da cultura comunitária e colabore com a governança cultural participativa.";
                $this->config["text:home-register.title"] = "Forma parte de esta plataforma libre, colaborativa e interactiva que conecta agentes culturales, iniciativas y espacios en toda Iberoamérica. Contribuye al fortalecimiento de la cultura comunitaria y colabora con la gobernanza cultural participativa.";
                ...
                $this->config["text:home-feature.description"] = "Revisá los últimos destacados de cada una de las áreas.";
                $this->config["text:home-register.title"] = "Forma parte de esta plataforma libre, colaborativa e interactiva que conecta agentes culturales, iniciativas y espacios en toda Iberoamérica. Contribuye al fortalecimiento de la cultura comunitaria y colabora con la gobernanza cultural participativa.";
